...
- __Bjerksund-Stensland Model__: A closed-form approximation of the Binomial/Trinomial Model detailed in 1993 and [revised in 2002](https://derivativesacademy.com/storage/uploads/files/modules/resources/1703192811_bjerksund_stensland_2002_closed_form_valuation_of_american_options.pdf). It is slightly less accurate, but it is much faster to compute and takes in the same parameters as the Black-Sholes model ($S_0, K, r, T, \sigma$).
